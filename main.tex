...
%TODO Wound wait, nonpreemptive とかの正式名称は？
...
%TODO 実際、len=32に設定するとlatestでも同じ結果になることを示せば良い。このデータが示せない！lenをどれだけ増やしても変わらなかった…
%TODO 224スレッドで性能が出ないのは、223スレッドなら性能出るかも?と思ったけどあんま変わらない。214, 220, 222, 223も試したけど
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-a/latency}
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-a/latency2}
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-b/latency}
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-b/latency2}
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-c/latency}
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-c/latency-2}
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-a/delay}
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-a/delay2}
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-b/delay}
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-b/delay2}
\caption{YCSB-B スレッド数とdelay}
\label{fig:delay-b2}
\end{figure}
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-c/delay}
...
%TODO なぜoldはこのような飛び飛びの値になるのか？もしかしたら、initのタイミングが遅すぎる？
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-a/std-div}
...
\begin{figure}[h] 
\centering
\includegraphics[width=7cm]{data/stable/ycsb-b/std-div}
