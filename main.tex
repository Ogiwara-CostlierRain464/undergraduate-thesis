...
しかしながら、この有向森構造には非効率な並行性制御によりアクセスするスレッドが増えるに従ってパフォーマンスが低下する問題、及び座標変換の計算時に最新のデータを参照することができないという問題があることがわかった。そこで、我々はデータベースの並行性制御技術における細粒度ロッキング法、及び2PLを応用することにより、この問題を解決した。提案手法では既存手法と比べ最大455倍のスループットを出すことを示した。
}
...
\caption{YCSB-Aにおけるスレッド数とスループットの関係 opposite\_writeフラグを有効にした場合}
...
\caption{YCSB-Aにおけるスレッド数とスループットの関係 opposite\_writeフラグを無効にした場合}
...
\caption{YCSB-Aにおけるスレッド数とabort率の関係 opposite\_writeフラグを有効にした場合}
...
\caption{YCSB-Aにおけるスレッド数とabort率の関係 opposite\_writeを無効にした場合}
...
\caption{YCSB-Aにおけるスレッド数と読み込みレイテンシの関係 opposite\_writeフラグを有効にした場合}
...
\caption{YCSB-Aにおけるスレッド数と読み込みレイテンシの関係 opposite\_writeフラグを有効にした場合 snapshotとlatestのみ}
...
\caption{YCSB-Aにおけるスレッド数と書き込みレイテンシの関係 opposite\_writeフラグを有効にした場合}
...
\caption{YCSB-Aにおけるスレッド数と書き込みレイテンシの関係 opposite\_writeフラグを有効にした場合 snapshotとlatestのみ}
...
\caption{YCSB-Aにおけるスレッド数と読み込みレイテンシの関係 opposite\_writeフラグを無効にした場合}
...
\caption{YCSB-Aにおけるスレッド数と読み込みレイテンシの関係 opposite\_writeフラグを無効にした場合 snapshotとlatestのみ}
...
\caption{YCSB-Aにおけるスレッド数と書き込みレイテンシの関係 opposite\_writeフラグを無効にした場合}
...
\caption{YCSB-Aにおけるスレッド数と書き込みレイテンシの関係 opposite\_writeフラグを無効にした場合 snapshotとlatestのみ}
...
\caption{YCSB-Aにおけるスレッド数と読み込みスループットの関係 opposite\_writeフラグを有効にした場合}
...
\caption{YCSB-Aにおけるスレッド数と書き込みスループットの関係 opposite\_writeフラグを有効にした場合}
...
\caption{YCSB-Aにおけるスレッド数と読み込みスループットの関係 opposite\_writeフラグを無効にした場合}
...
\caption{YCSB-Aにおけるスレッド数と書き込みスループットの関係 opposite\_writeフラグを無効にした場合}
...
\caption{YCSB-Aにおけるスレッド数とdelayの関係  opposite\_writeフラグを有効にした場合}
...
\caption{YCSB-Aにおけるスレッド数とdelayの関係 opposite\_writeフラグを有効にした場合 snapshotとlatestのみ}
...
\caption{YCSB-Aにおけるスレッド数とdelayの関係 opposite\_writeフラグを無効にした場合}
...
\caption{YCSB-Aにおけるスレッド数とdelayの関係 opposite\_writeフラグを無効にした場合 snapshotとlatestのみ}
...
opposite\_writeフラグの有効・無効に関わらず、snapshotよりlatestの方がデータの鮮度が高いことがわかった。これは、§\ref{section:intro-2pl}で説明したように、latestのlookupLatestTransformでは時刻の同期を取ることなく最新の座標変換データを取得するからだと考えられる。
...
\caption{YCSB-Aにおけるスレッド数と同期性の関係 opposite\_writeフラグを有効にした場合}
...
\caption{YCSB-Aにおけるスレッド数と同期性の関係 opposite\_writeフラグを無効にした場合}
