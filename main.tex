...
%TODO: ここは、例外パターンへの対処のためにこうしているけれど…もっと説明すべき？
...
% 地面に接触するリンクの位置情報を用いたヘビ型ロボットの自己位置推定
